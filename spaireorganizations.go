...
type SpaireOrganizations struct {
	rootSDK          *Spaire
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newSpaireOrganizations(rootSDK *Spaire, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *SpaireOrganizations {
	return &SpaireOrganizations{
		rootSDK:          rootSDK,
...
func (s *SpaireOrganizations) Get(ctx context.Context, slug string, opts ...operations.Option) (*operations.CustomerPortalOrganizationsGetResponse, error) {
