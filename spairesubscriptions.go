...
type SpaireSubscriptions struct {
	rootSDK          *Spaire
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newSpaireSubscriptions(rootSDK *Spaire, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *SpaireSubscriptions {
	return &SpaireSubscriptions{
		rootSDK:          rootSDK,
...
func (s *SpaireSubscriptions) List(ctx context.Context, request operations.CustomerPortalSubscriptionsListRequest, security operations.CustomerPortalSubscriptionsListSecurity, opts ...operations.Option) (*operations.CustomerPortalSubscriptionsListResponse, error) {
...
//
// **Scopes**: `customer_portal:read` `customer_portal:write`
func (s *SpaireSubscriptions) Get(ctx context.Context, security operations.CustomerPortalSubscriptionsGetSecurity, id string, opts ...operations.Option) (*operations.CustomerPortalSubscriptionsGetResponse, error) {
...
func (s *SpaireSubscriptions) Cancel(ctx context.Context, security operations.CustomerPortalSubscriptionsCancelSecurity, id string, opts ...operations.Option) (*operations.CustomerPortalSubscriptionsCancelResponse, error) {
...
func (s *SpaireSubscriptions) Update(ctx context.Context, security operations.CustomerPortalSubscriptionsUpdateSecurity, id string, customerSubscriptionUpdate components.CustomerSubscriptionUpdate, opts ...operations.Option) (*operations.CustomerPortalSubscriptionsUpdateResponse, error) {
